...
rs = ps.executeQuery();
if(rs.next()){
	JOptionPane.showMessageDialog(null,"billmember, login successfully.........");
	bill.main(null);
}
else {
...
JLabel lblNewLabel_2 = new JLabel("BILL MEMBER REGISTER AND LOGIN");
